      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <h2 className="heading-lg">
            Твой внутренний
            <br />
            <span className="italic text-accent">код перехода</span>
          </h2>
        </motion.div>
        ...
        >
          <div className="flex items-start gap-4 mb-6">
            <span className="text-5xl">{primary.symbol}</span>
            <div>
              ...
              <p className="text-muted-foreground italic text-lg">{primary.subtitle}</p>
            </div>
          </div>
          ...
          <div className="mt-8 brutal-card bg-accent p-6">
            <h4 className="font-black text-lg font-serif mb-2">Направление роста</h4>
            <p className="text-accent-foreground/80">{primary.growthDirection}</p>
          </div>

          <div className="mt-6">
            <h4 className="font-black text-lg font-serif mb-4">Первые шаги</h4>
        ...
        {secondary && (
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <span className="text-3xl">{secondary.symbol}</span>
              <div>
                <span className="tag-brutal text-[10px]">Дополнительный архетип</span>
                <h4 className="text-xl font-black font-serif">{secondary.name}</h4>
              </div>
            </div>
