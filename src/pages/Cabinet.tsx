...
import { LogOut, ArrowLeft, Trash2, Calendar, Loader2 } from "lucide-react";
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-2 mt-3">
                      {Object.entries(result.scores).map(([key, value]) => (
                        <span
                          key={key}
                          className="text-xs px-2 py-1 bg-muted border border-foreground/10"
                        >
                          {key}: <strong>{value}</strong>/10
                        </span>
                      ))}
                    </div>
                  </div>
